...
public class LottoTextFileOutGUI {
	private static final Random rnd = new Random(); //random generator
	...
	public void run() {
		maximum =
			giveANumberBetweenMinAndMax(
				"Welk is het maximum te genereren getal? (min 10, max 42) ",
				10,
				42);
		numberOfElements =
			giveANumberBetweenMinAndMax(
				"Hoeveel combinaties wenst u te genereren? (min 1) ",
				1,
				Integer.MAX_VALUE);
		generateTextFile();
