...
public class CalculatorTest {
    ...
    public static void main(final String[] args) throws IllegalArgumentException, IOException {
        ...
        switch (source){
            case 'U': userDialog(calculations); break;
            case 'F': calculations = IOCalculator.getCalculationsFromFile("calculations.txt");break;
            case 'S': calculations = IOCalculator.getCalculationsFromScanner("calculations.txt");break;
            default: calculations = IOCalculator.getRandomCalculations();
        }
