...
public class Driver {
	...
	public static void main(String[] args) {
		...
		try {
			...
			myTest = (Testable) Naming.lookup("//localhost/test");
	...
	public static void presentTest(Testable test) throws RemoteException {
		int correctIndex = 0;
		int choiceIndex = 0;
	...
	public static void presentResults(Testable test) throws RemoteException {
