package lab9.solution.driver;

import lab9.solution.model.*;
...
public class Driver {
	...
	public static void displayTestProperties(Testable test) throws java.rmi.RemoteException{
	...
	public static void main(String[] args) {
		...
		try{
			...
			myTest = (Testable)java.rmi.Naming.lookup("//localhost/test");
	...
	public static void presentResults(Testable test) throws java.rmi.RemoteException{
		// Score test
	...
	public static void presentTest(Testable test) throws java.rmi.RemoteException{
		int correctIndex = 0;
		...
		for (int qnum = 0; qnum < test.getQuestionCount(); qnum++) {
		   Question question = test.getQuestion(qnum);
			...
			int cnum;
			for (cnum = 0; cnum < question.getCount(); cnum++) {
