...
{
	public void serve(final InputStream i, final OutputStream o) throws IOException
	{
		...
		try
		{
			final String tmpdir = System.getProperty("service.tmp");
			out.println(tmpdir);
			final File dir = new File(tmpdir);
			final File f = new File(dir, "testfile");
