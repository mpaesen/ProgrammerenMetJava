...
public class OurString
{
    ...
    public static String convert(String source,  String fromChars,
                                 String toChars, int    start) throws BadStartPositionException, BadLengthException
    {
        String resultString;
        ...
        if (start > source.length() || start < 0)
          throw new BadStartPositionException();
     ...
     */
    public static String convert(String source,  String fromChars,
                                 String toChars)      throws BadInputException
    {
