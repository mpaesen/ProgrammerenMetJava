...
public class CarLot {
    ...
    private Car getAvailableRental(String carClass, String color, String make) {
        ...
        for (int idx = 0; idx < cars.size(); idx++) {
            ...
            if (!currCar.isRented() && ((carClass == null) || (carClass.equalsIgnoreCase(currCar.getClassification()))) &&
    ...
    public void addCarToLot(String plate, String classification, String make, String color) {
