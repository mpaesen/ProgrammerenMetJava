...
abstract class ComFmt implements Formatable {
    ...
    abstract public String[] getFormats();

    abstract public char[] getDefaultSeparators();
    ...
    public ComFmt(int format) {
        this.format = format;
        separator  = (char) - 1; // -1 implies use default
    }
    ...
    /**
     *  Set separator character for this format By default, appropriate default for the format is used
