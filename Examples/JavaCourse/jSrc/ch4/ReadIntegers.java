package jSrc.ch4;
/**
 *  Supplies a helper method to read integers from the
 *  command line. This class does not need to be instantiated
 */
public class ReadIntegers
{
    /**
      * reads another integer from the console.
      * Returns -9999 if the user chose to quit
      */
