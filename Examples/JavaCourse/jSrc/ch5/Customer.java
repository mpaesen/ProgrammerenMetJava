    ...
    public static void main(String args[])
    {
        ...
        if (args.length != 2)
        ...
        else
          {
             ...
             try
             {
                Float floatObject = Float.XXXX(rateAsString); // CHANGE XXXX
                rateAsFloat = floatObject.YYYY(); // CHANGE YYYY
             }
        ...
        System.out.println("Customer price: " + cust1.applyDiscount(ZZZZ)); // CHANGE ZZZZ
    }
