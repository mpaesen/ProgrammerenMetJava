...
public class FileViewer extends Frame
{
	...
	public FileViewer(final String filename) throws IOException
	{
		...
		final TextArea textarea = new TextArea(new String(data, 0), 24, 80);
	...
	@Override
	public boolean action(final Event e, final Object what)
	{
		if (e.target == close)
		{
			this.hide();
	...
	static public void main(final String[] args) throws IOException
	{
		...
		try
		{
			final Frame f = new FileViewer(args[0]);
		}
