...
public class ThreadLister
{
	...
	private static void print_thread_info(final PrintStream out, final Thread t, final String indent)
	{
		if (t == null)
			return;
	...
	private static void list_group(final PrintStream out, final ThreadGroup g, final String indent)
	{
		if (g == null)
			return;
