...
public class AllComponents extends Frame
{
	...
	public AllComponents(final String title)
	{
		super(title);
		...
		constrain(panel1, new Label("Favorite color:"), 0, 2, 1, 1, 10, 0, 0, 0);
		constrain(panel1, choice, 0, 3, 1, 1);
		constrain(panel1, new Label("Favorite flavor:"), 0, 4, 1, 1, 10, 0, 0, 0);
		constrain(panel1, checkboxes[0], 0, 5, 1, 1);
		constrain(panel1, checkboxes[1], 0, 6, 1, 1);
		constrain(panel1, checkboxes[2], 0, 7, 1, 1);
		constrain(panel1, new Label("Favorite languages:"), 0, 8, 1, 1, 10, 0, 0, 0);
		constrain(panel1, list, 0, 9, 1, 3, GridBagConstraints.VERTICAL, GridBagConstraints.NORTHWEST, 0.0, 1.0, 0, 0, 0, 0);
		...
		constrain(panel2, textarea, 0, 1, 1, 3, GridBagConstraints.HORIZONTAL, GridBagConstraints.NORTH, 1.0, 0.0, 0, 0, 0, 0);
		...
		constrain(buttonpanel, okay, 0, 0, 1, 1, GridBagConstraints.NONE, GridBagConstraints.CENTER, 0.3, 0.0, 0, 0, 0, 0);
		constrain(buttonpanel, cancel, 1, 0, 1, 1, GridBagConstraints.NONE, GridBagConstraints.CENTER, 0.3, 0.0, 0, 0, 0, 0);

		// Finally, use a GridBagLayout to arrange the panels themselves
		this.setLayout(gridbag);
		// And add the panels to the toplevel window
		constrain(this, panel1, 0, 0, 1, 1, GridBagConstraints.VERTICAL, GridBagConstraints.NORTHWEST, 0.0, 1.0, 10, 10, 5, 5);
		constrain(this, panel2, 1, 0, 1, 1, GridBagConstraints.BOTH, GridBagConstraints.CENTER, 1.0, 1.0, 10, 10, 5, 10);
		constrain(this, buttonpanel, 0, 1, 2, 1, GridBagConstraints.HORIZONTAL, GridBagConstraints.CENTER, 1.0, 0.0, 5, 0, 0, 0);
	}

	public void constrain(final Container container, final Component component, final int grid_x, final int grid_y, final int grid_width, final int grid_height, final int fill, final int anchor, final double weight_x, final double weight_y, final int top, final int left, final int bottom,
			final int right)
	{
	...
	public void constrain(final Container container, final Component component, final int grid_x, final int grid_y, final int grid_width, final int grid_height)
	{
	...
	public void constrain(final Container container, final Component component, final int grid_x, final int grid_y, final int grid_width, final int grid_height, final int top, final int left, final int bottom, final int right)
	{
	...
	{
		final Frame f = new AllComponents("AWT Demo");
