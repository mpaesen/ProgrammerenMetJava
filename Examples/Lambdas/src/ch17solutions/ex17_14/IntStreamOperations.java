package ch17solutions.ex17_14;

// Exercise 17.14: IntStreamOperations.java
...
public class IntStreamOperations
{
	public static void main(final String[] args)
	{
		...
		System.out.printf("Sum of squares via map then reduce: %d%n", IntStream.of(values).map(value -> value * value).reduce(0, (x, y) -> x + y));
