...
public class TestJDBCHainaut{
  public static void main(String args[]){
  	String as400 = new String("ASDELTA1");
	...
	Connection con = DriverManager.getConnection("jdbc:as400://ASDELTA1;naming=sql;errors=full;dateformat=iso;extended dynamic=true;package=JDBCEX;package library=QGPL,INSTJAVA,INSTJAVA");
